...
@Autonomous(name = "RedFoundationParkBridge", group = "Pushbot")
public class RedFoundationParkBridge extends MecanumAutonomous{
    @Override
...
//        turn(DRIVE_SPEED,-2, - 2, 3);
        ...
        //Parks on bridge side
        drive(DRIVE_SPEED, -15, 2);
        strafeLeft(DRIVE_SPEED, 15, 2);
        drive(DRIVE_SPEED, -15, 2);

        //rn the two red foundation autons are the same except the name
